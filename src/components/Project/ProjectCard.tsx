...
export default function ProjectCard({
  links, projectDescription, projectImg, projectName, projectSubtitle, projectTechUsed,
}:Project) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Heading
            fontSize={['1.4rem', '2rem', '2rem', '2.2rem']}
          >
            {projectName}
            <br />
            {projectSubtitle}
          ...
          >
            ...
            <Button
              as="a"
              border="1px"
              leftIcon={<Icon icon="material-symbols:code" width="30px" />}
              fontSize="1.5rem"
              p="2rem"
              href={links.github}
            >
